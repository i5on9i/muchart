 ...
 */
package com.namh.widget.flowindicator;
...
public class TitleFlowIndicator extends TextView implements FlowIndicator {
	...
	public TitleFlowIndicator(Context context, AttributeSet attrs) {
		...
		for (int i = 0; i < N; ++i)
		{
			...
			switch (attr)
			{
				...
				case R.styleable.TitleFlowIndicator_customTypeface:
					customTypeface = a.getString(R.styleable.TitleFlowIndicator_customTypeface);
					
					break;
				case R.styleable.TitleFlowIndicator_footerColor:
					footerColor = a.getColor(R.styleable.TitleFlowIndicator_footerColor,
											FOOTER_COLOR);
					break;
				case R.styleable.TitleFlowIndicator_footerLineHeight:
					footerLineHeight = a.getDimension(R.styleable.TitleFlowIndicator_footerLineHeight,
											FOOTER_LINE_HEIGHT);
					break;
				case R.styleable.TitleFlowIndicator_footerTriangleHeight:
					footerTriangleHeight = a.getDimension(R.styleable.TitleFlowIndicator_footerTriangleHeight,
											FOOTER_TRIANGLE_HEIGHT);
					break;
				case R.styleable.TitleFlowIndicator_selectedColor:
					selectedColor = a.getColor(R.styleable.TitleFlowIndicator_selectedColor,
											SELECTED_COLOR);
					break;

				case R.styleable.TitleFlowIndicator_selectedBold:
					selectedBold = a.getBoolean(R.styleable.TitleFlowIndicator_selectedBold,
											SELECTED_BOLD);
					break;
				case R.styleable.TitleFlowIndicator_textColor:
					textColor = a.getColor(R.styleable.TitleFlowIndicator_textColor,
											TEXT_COLOR);
					break;
				case R.styleable.TitleFlowIndicator_textSize:
					textSize = a.getDimension(R.styleable.TitleFlowIndicator_textSize,
											TEXT_SIZE);
					break;
				case R.styleable.TitleFlowIndicator_selectedSize:
					selectedSize = a.getDimension(R.styleable.TitleFlowIndicator_selectedSize,
											TEXT_SIZE);
					break;
				case R.styleable.TitleFlowIndicator_titlePadding:
					titlePadding = a.getDimension(R.styleable.TitleFlowIndicator_titlePadding,
											TITLE_PADDING);
					break;
				case R.styleable.TitleFlowIndicator_clipPadding:
					clipPadding = a.getDimension(R.styleable.TitleFlowIndicator_clipPadding,
											CLIP_PADDING);
					break;
			}
		}
	...
	protected void onDraw(Canvas canvas) {
		...
		int count = (viewFlow != null && viewFlow.getAdapter() != null)
					? viewFlow.getAdapter().getCount() : 1;
